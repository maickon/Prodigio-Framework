                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="action_btns d-flex">
                                                            <a href="/dashboard/nome/<?= $object->id ?>/editar" class="action_btn mr_10">
                                                                <i class="far fa-edit"></i>
                                                            </a>
                                                            <a href="/dashboard/nome/<?= $object->id ?>/excluir" class="action_btn delete" data-bs-toggle="modal" data-bs-target="#modal" data-title="Deletar registro" data-message="Tem certeza que deseja deletar este registro?">
