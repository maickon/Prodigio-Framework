                                        ...
                                        <table class="table lms_table_active ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $object->status ?></td>
                                                    <td><?= (empty($object->client->name) ? 'Cliente Exluído' : $object->client->name) ?></td>
                                                    <td><?= $object->name->name ?></td>
                                                    <td><?= $object->brand->name ?></td>
                                                    <td><?= $object->product_code ?></td>
                                                    <td><?= date("d/m/Y h:i:s",strtotime($object->created_at)) ?></td>
                                                    <td>
                                                        <div class="action_btns d-flex">
                                                            <a href="/dashboard/pedido/<?= $object->id ?>/editar" class="action_btn mr_10">
                                                                <i class="far fa-edit"></i>
                                                            </a>
                                                            <a href="/dashboard/pedido/<?= $object->id ?>/excluir" class="action_btn delete" data-bs-toggle="modal" data-bs-target="#modal" data-title="Deletar registro" data-message="Tem certeza que deseja deletar este registro?">
